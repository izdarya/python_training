...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.add_contact(wd, contact(first="Dasha", middle="Dasha", last="Dasha", nickname="Dasha", company="Test", title="Test", address="Test", telephone_home="2-22-22", telephone_mobile="8-977-983-01-25",
                         work="Test", email="Test@test.ru", year="1994", address_s="Test", home="Test", notes="Test", day="8", month="June"))
