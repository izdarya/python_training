...
class TestAddContact(unittest.TestCase):
    ...
    def add_contact(self, wd):
        ...
        wd.find_element_by_name("firstname").send_keys("Dasha")
        wd.find_element_by_name("middlename").click()
        wd.find_element_by_name("middlename").clear()
        wd.find_element_by_name("middlename").send_keys("Dasha")
        wd.find_element_by_name("lastname").click()
        wd.find_element_by_name("lastname").clear()
        wd.find_element_by_name("lastname").send_keys("Dasha")
        wd.find_element_by_name("nickname").click()
        wd.find_element_by_name("nickname").clear()
        wd.find_element_by_name("nickname").send_keys("Dasha")
        ...
        wd.find_element_by_name("home").send_keys("2-22-22")
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("8-977-983-01-25")
        ...
        wd.find_element_by_name("phone2").send_keys("Test")
